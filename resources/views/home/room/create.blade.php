...
@section('content')
    <div class="content-wrapper px-4 py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h1 class="h3 mb-1 text-dark fw-bold">새 채팅방 만들기</h1>
                <!-- 브레드크럼 -->
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">새 채팅방</li>
                    </ol>
                </nav>
            </div>
            <div>
        ...
        <div class="row">
            <!-- 메인 생성 영역 -->
            <div class="col-lg-8">
                <form method="POST" action="{{ route('home.chat.rooms.store') }}" enctype="multipart/form-data">
                    @csrf
                                    ...
                                    <div class="col-md-6">
                                        <div class="p-3 border rounded h-100">
                                            ...
                                            @error('password')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                            <small class="form-text text-muted">참여 시 비밀번호 입력이 필요합니다.</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="sidebar-card">
                    ...
                    <div class="sidebar-body">
                        <div class="text-muted">
                            ...
                            <hr>
                            <p><strong>채팅방 타입:</strong></p>
                            <ul class="list-unstyled">
                                <li>• <strong>공개:</strong> 누구나 검색하고 참여 가능</li>
                                <li>• <strong>비공개:</strong> 초대를 통해서만 참여 가능</li>
                                <li>• <strong>그룹:</strong> 소규모 그룹을 위한 채팅방</li>
                            </ul>
                            <hr>
                            <p><strong>접근 설정:</strong></p>
                            <p class="small">검색 가능, 자유 참여, 초대 허용 등의 설정을 통해 채팅방의 접근 권한을 조절할 수 있습니다.</p>
                            <hr>
                            <p class="small text-info">
                                <i class="fas fa-lightbulb"></i>
                                채팅방 생성 후에도 설정을 변경할 수 있습니다.
                            </p>
                        </div>
                    </div>
                </div>
